    ...
    public void drawTextBox() {
        if (this.func_146176_q()) {
            if (this.func_146181_i()) {
                GuiPasswordBox.drawRect(this.field_146209_f - 1, this.field_146210_g - 1, this.field_146209_f + this.field_146218_h + 1, this.field_146210_g + this.field_146219_i + 1, -6250336);
                GuiPasswordBox.drawRect(this.field_146209_f, this.field_146210_g, this.field_146209_f + this.field_146218_h, this.field_146210_g + this.field_146219_i, -16777216);
            }
            ...
            if (var4.length() > 0) {
                ...
                var9 = this.field_146211_a.drawStringWithShadow(this.show ? var10 : var10.replaceAll("(?s).", "*"), var7, var8, var1);
            }
