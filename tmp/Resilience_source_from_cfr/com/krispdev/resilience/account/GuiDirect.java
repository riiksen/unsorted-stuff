...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new ResilienceButton(0, Resilience.getInstance().getInvoker().getWidth() / 2 - 102, Resilience.getInstance().getInvoker().getHeight() / 2 + 25, 204.0f, 20.0f, "Login"));
    ...
    public void drawScreen(int i, int j, float f) {
        GuiDirect.drawRect(0, 0, Resilience.getInstance().getInvoker().getWidth(), Resilience.getInstance().getInvoker().getHeight(), -15724528);
    ...
    protected void actionPerformed(GuiButton par1) {
        ...
        if (par1.id == 0) {
            Account acc = new Account(this.usernameBox.getText(), this.passwordBox.getText());
