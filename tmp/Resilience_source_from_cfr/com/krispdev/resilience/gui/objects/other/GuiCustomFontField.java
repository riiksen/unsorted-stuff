...
public class GuiCustomFontField
extends Gui {
    private String text = "";
    ...
    public void drawTextBox() {
        if (this.func_146176_q()) {
            if (this.func_146181_i()) {
                GuiCustomFontField.drawRect(this.field_146209_f - 1, this.field_146210_g - 1, this.field_146209_f + this.field_146218_h + 1, this.field_146210_g + this.field_146219_i + 1, -6250336);
                GuiCustomFontField.drawRect(this.field_146209_f, this.field_146210_g, this.field_146209_f + this.field_146218_h, this.field_146210_g + this.field_146219_i, -16777216);
            }
            ...
            if (var6 && var13) {
                Gui.drawRect(var11, var8 - 1, var11 + 1, (int)((float)(var8 + 1) + this.field_146211_a.getHeight(this.text)), -3092272);
            }
            if (var3 != var2) {
                int var12 = (int)((float)var7 + this.field_146211_a.getWidth(var4.substring(0, var3)));
                this.func_146188_c(var11, var8 - 1, var12 - 1, (int)((float)(var8 + 1) + this.field_146211_a.getHeight(this.text)));
            }
        }
    }
