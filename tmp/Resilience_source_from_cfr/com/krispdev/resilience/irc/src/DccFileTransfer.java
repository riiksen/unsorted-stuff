...
import com.krispdev.resilience.irc.src.DccManager;
...
public class DccFileTransfer {
                ...
                block12 : {
                    ...
                    try {
                        try {
                            ...
                            String ipStr = String.valueOf(ip[0]) + "." + ip[1] + "." + ip[2] + "." + ip[3];
    ...
    static /* synthetic */ void access$4(DccFileTransfer dccFileTransfer, Socket socket) {
        dccFileTransfer._socket = socket;
    }

    static /* synthetic */ void access$5(DccFileTransfer dccFileTransfer, long l) {
        dccFileTransfer._startTime = l;
    }

    static /* synthetic */ void access$8(DccFileTransfer dccFileTransfer, long l) {
        dccFileTransfer._progress = l;
    }

    static /* synthetic */ void access$11(DccFileTransfer dccFileTransfer, int n) {
