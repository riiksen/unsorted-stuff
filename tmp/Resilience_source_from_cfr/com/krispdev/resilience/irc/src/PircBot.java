...
implements ReplyConstants {
    ...
    public final void startIdentServer() {
        new com.krispdev.resilience.irc.src.IdentServer(this, this.getLogin());
    }
