...
implements Font {
    ...
    private void initializeFont(java.awt.Font baseFont, int size, boolean bold, boolean italic) {
        ...
        attributes.put(TextAttribute.SIZE, (Float)new Float(size));
        attributes.put(TextAttribute.WEIGHT, (Float)(bold ? TextAttribute.WEIGHT_BOLD : TextAttribute.WEIGHT_REGULAR));
        attributes.put(TextAttribute.POSTURE, (Float)(italic ? TextAttribute.POSTURE_OBLIQUE : TextAttribute.POSTURE_REGULAR));
        try {
            attributes.put((TextAttribute)TextAttribute.class.getDeclaredField("KERNING").get(null), (Object)TextAttribute.class.getDeclaredField("KERNING_ON").get(null));
        }
    ...
    public int getYOffset(String text) {
        ...
        char[] chars = text.toCharArray();
        GlyphVector vector = this.font.layoutGlyphVector(GlyphPage.renderContext, chars, 0, chars.length, 0);
        int yOffset = this.ascent + vector.getPixelBounds((FontRenderContext)null, (float)0.0f, (float)0.0f).y;
        if (displayList != null) {
