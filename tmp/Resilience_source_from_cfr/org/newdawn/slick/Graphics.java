    ...
    public void drawLine(float x1, float y1, float x2, float y2) {
        ...
        if (LSR.applyGLLineFixes()) {
            if (x1 == x2) {
                ...
                this.fillRect(x1 - lineWidth / 2.0f, y1 - lineWidth / 2.0f, lineWidth + step, y2 - y1 + (lineWidth /= this.sy) + step);
                return;
            }
            if (y1 == y2) {
                if (x1 > x2) {
                ...
                this.fillRect(x1 - lineWidth / 2.0f, y1 - lineWidth / 2.0f, x2 - x1 + lineWidth + step, (lineWidth /= this.sx) + step);
                return;
            }
        }
        this.predraw();
