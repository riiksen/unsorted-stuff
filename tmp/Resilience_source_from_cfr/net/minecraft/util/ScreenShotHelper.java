...
public class ScreenShotHelper {
    ...
    public static IChatComponent saveScreenshot(File p_148259_0_, String p_148259_1_, int p_148259_2_, int p_148259_3_, Framebuffer p_148259_4_) {
        try {
            ...
            pixelBuffer.clear();
            if (OpenGlHelper.isFramebufferEnabled()) {
                GL11.glBindTexture((int)3553, (int)p_148259_4_.framebufferTexture);
    ...
    private static File getTimestampedPNGFileForDirectory(File par0File) {
        ...
        int var3 = 1;
        File var1;
        while ((var1 = new File(par0File, String.valueOf(var2) + (var3 == 1 ? "" : new StringBuilder("_").append(var3).toString()) + ".png")).exists()) {
            ++var3;
        }
        return var1;
    }
