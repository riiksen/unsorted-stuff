...
extends CommandBase {
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr) {
        if (par2ArrayOfStr.length == 1) {
            if (par2ArrayOfStr[0].equals("start")) {
                CommandDebug.notifyAdmins(par1ICommandSender, "commands.debug.start", new Object[0]);
            ...
            if (par2ArrayOfStr[0].equals("stop")) {
                ...
                CommandDebug.notifyAdmins(par1ICommandSender, "commands.debug.stop", Float.valueOf((float)var6 / 1000.0f), var8);
                return;
            }
        }
    ...
    public List addTabCompletionOptions(ICommandSender par1ICommandSender, String[] par2ArrayOfStr) {
        return par2ArrayOfStr.length == 1 ? CommandDebug.getListOfStringsMatchingLastWord(par2ArrayOfStr, "start", "stop") : null;
    }
}
