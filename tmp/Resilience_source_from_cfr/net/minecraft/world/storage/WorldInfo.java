...
public class WorldInfo {
    ...
    public WorldInfo(NBTTagCompound par1NBTTagCompound) {
        ...
        this.mapFeaturesEnabled = par1NBTTagCompound.func_150297_b("MapFeatures", 99) ? par1NBTTagCompound.getBoolean("MapFeatures") : true;
        ...
        this.worldTime = par1NBTTagCompound.func_150297_b("DayTime", 99) ? par1NBTTagCompound.getLong("DayTime") : this.totalTime;
        ...
        this.initialized = par1NBTTagCompound.func_150297_b("initialized", 99) ? par1NBTTagCompound.getBoolean("initialized") : true;
