...
extends MapGenBase {
    ...
    protected void func_151541_a(long p_151541_1_, int p_151541_3_, int p_151541_4_, Block[] p_151541_5_, double p_151541_6_, double p_151541_8_, double p_151541_10_, float p_151541_12_, float p_151541_13_, float p_151541_14_, int p_151541_15_, int p_151541_16_, double p_151541_17_) {
        ...
        while (p_151541_15_ < p_151541_16_) {
            double var29 = 1.5 + (double)(MathHelper.sin((float)p_151541_15_ * 3.1415927f / (float)p_151541_16_) * p_151541_12_ * 1.0f);
            ...
            p_151541_14_ = var28 ? (p_151541_14_ *= 0.92f) : (p_151541_14_ *= 0.7f);
            ...
            if (!var54 && p_151541_15_ == var27 && p_151541_12_ > 1.0f && p_151541_16_ > 0) {
                this.func_151541_a(var25.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_, p_151541_10_, var25.nextFloat() * 0.5f + 0.5f, p_151541_13_ - 1.5707964f, p_151541_14_ / 3.0f, p_151541_15_, p_151541_16_, 1.0);
                this.func_151541_a(var25.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_, p_151541_10_, var25.nextFloat() * 0.5f + 0.5f, p_151541_13_ + 1.5707964f, p_151541_14_ / 3.0f, p_151541_15_, p_151541_16_, 1.0);
                return;
            }
            if (var54 || var25.nextInt(4) != 0) {
                ...
                if (p_151541_6_ >= var19 - 16.0 - var29 * 2.0 && p_151541_10_ >= var21 - 16.0 - var29 * 2.0 && p_151541_6_ <= var19 + 16.0 + var29 * 2.0 && p_151541_10_ <= var21 + 16.0 + var29 * 2.0) {
                    int var45;
                    ...
                    if (!var58) {
                        var42 = var55;
                        while (var42 < var36) {
                            double var60 = ((double)(var42 + p_151541_3_ * 16) + 0.5 - p_151541_6_) / var29;
                            var45 = var56;
                            while (var45 < var40) {
                                double var59 = ((double)(var45 + p_151541_4_ * 16) + 0.5 - p_151541_10_) / var29;
                                int var48 = (var42 * 16 + var45) * 256 + var38;
                                boolean var49 = false;
                                if (var60 * var60 + var59 * var59 < 1.0) {
                                    int var50 = var38 - 1;
                                    while (var50 >= var57) {
                                        double var51 = ((double)var50 + 0.5 - p_151541_8_) / var31;
                                        if (var51 > -0.7 && var60 * var60 + var51 * var51 + var59 * var59 < 1.0) {
                                            ...
                                            if (var53 == Blocks.stone || var53 == Blocks.dirt || var53 == Blocks.grass) {
                                                if (var50 < 10) {
                                                    ...
                                                    if (var49 && p_151541_5_[var48 - 1] == Blocks.dirt) {
                                                        p_151541_5_[var48 - 1] = this.worldObj.getBiomeGenForCoords((int)(var42 + p_151541_3_ * 16), (int)(var45 + p_151541_4_ * 16)).topBlock;
                                                    }
                                                }
                                            }
                                        }
    ...
    protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_) {
        ...
        while (var8 < var7) {
            ...
            while (var16 < var15) {
                ...
                this.func_151541_a(this.rand.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, var9, var11, var13, var19, var17, var18, 0, 0, 1.0);
                ++var16;
            }
            ++var8;
        }
