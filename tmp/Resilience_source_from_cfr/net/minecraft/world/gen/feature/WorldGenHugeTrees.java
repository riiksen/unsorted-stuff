...
extends WorldGenAbstractTree {
    ...
    private boolean func_150536_b(World p_150536_1_, Random p_150536_2_, int p_150536_3_, int p_150536_4_, int p_150536_5_, int p_150536_6_) {
        ...
        if (p_150536_4_ >= 1 && p_150536_4_ + p_150536_6_ + 1 <= 256) {
            int var8 = p_150536_4_;
            while (var8 <= p_150536_4_ + 1 + p_150536_6_) {
                int var9 = 2;
                if (var8 == p_150536_4_) {
                    var9 = 1;
                }
                ...
                int var10 = p_150536_3_ - var9;
                while (var10 <= p_150536_3_ + var9 && var7) {
                    int var11 = p_150536_5_ - var9;
                    while (var11 <= p_150536_5_ + var9 && var7) {
                        if (var8 >= 0 && var8 < 256) {
    ...
    protected boolean func_150537_a(World p_150537_1_, Random p_150537_2_, int p_150537_3_, int p_150537_4_, int p_150537_5_, int p_150537_6_) {
        if (this.func_150536_b(p_150537_1_, p_150537_2_, p_150537_3_, p_150537_4_, p_150537_5_, p_150537_6_) && this.func_150532_c(p_150537_1_, p_150537_2_, p_150537_3_, p_150537_4_, p_150537_5_)) {
            return true;
        }
        return false;
    }
    ...
    protected void func_150535_a(World p_150535_1_, int p_150535_2_, int p_150535_3_, int p_150535_4_, int p_150535_5_, Random p_150535_6_) {
        ...
        int var8 = p_150535_2_ - p_150535_5_;
        while (var8 <= p_150535_2_ + p_150535_5_ + 1) {
            int var9 = var8 - p_150535_2_;
            int var10 = p_150535_4_ - p_150535_5_;
            while (var10 <= p_150535_4_ + p_150535_5_ + 1) {
                Block var14;
                int var11 = var10 - p_150535_4_;
                int var12 = var9 - 1;
                int var13 = var11 - 1;
                if (!(var9 * var9 + var11 * var11 > var7 && var12 * var12 + var13 * var13 > var7 && var9 * var9 + var13 * var13 > var7 && var12 * var12 + var11 * var11 > var7 || (var14 = p_150535_1_.getBlock(var8, p_150535_3_, var10)).getMaterial() != Material.air && var14.getMaterial() != Material.leaves)) {
    ...
    protected void func_150534_b(World p_150534_1_, int p_150534_2_, int p_150534_3_, int p_150534_4_, int p_150534_5_, Random p_150534_6_) {
        ...
        int var8 = p_150534_2_ - p_150534_5_;
        while (var8 <= p_150534_2_ + p_150534_5_) {
            int var9 = var8 - p_150534_2_;
            int var10 = p_150534_4_ - p_150534_5_;
            while (var10 <= p_150534_4_ + p_150534_5_) {
                Block var12;
                int var11 = var10 - p_150534_4_;
                if (var9 * var9 + var11 * var11 <= var7 && ((var12 = p_150534_1_.getBlock(var8, p_150534_3_, var10)).getMaterial() == Material.air || var12.getMaterial() == Material.leaves)) {
