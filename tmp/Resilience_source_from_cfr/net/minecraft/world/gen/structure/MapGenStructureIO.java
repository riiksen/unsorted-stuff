...
public class MapGenStructureIO {
    ...
    static {
        MapGenStructureIO.func_143034_b(StructureMineshaftStart.class, "Mineshaft");
        MapGenStructureIO.func_143034_b(MapGenVillage.Start.class, "Village");
        MapGenStructureIO.func_143034_b(MapGenNetherBridge.Start.class, "Fortress");
        MapGenStructureIO.func_143034_b(MapGenStronghold.Start.class, "Stronghold");
