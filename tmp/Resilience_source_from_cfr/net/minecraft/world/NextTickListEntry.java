...
implements Comparable {
    ...
    public boolean equals(Object par1Obj) {
        ...
        if (this.xCoord == var2.xCoord && this.yCoord == var2.yCoord && this.zCoord == var2.zCoord && Block.isEqualTo(this.field_151352_g, var2.field_151352_g)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return String.valueOf(Block.getIdFromBlock(this.field_151352_g)) + ": (" + this.xCoord + ", " + this.yCoord + ", " + this.zCoord + "), " + this.scheduledTime + ", " + this.priority + ", " + this.tickEntryID;
    }
