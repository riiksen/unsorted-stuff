...
extends ItemBlock {
    ...
    public String getUnlocalizedName(ItemStack par1ItemStack) {
        ...
        return var2 >= 0 && var2 < this.field_150945_c.length ? String.valueOf(super.getUnlocalizedName(par1ItemStack)) + "." + this.field_150945_c[var2] : super.getUnlocalizedName(par1ItemStack);
    }
}
