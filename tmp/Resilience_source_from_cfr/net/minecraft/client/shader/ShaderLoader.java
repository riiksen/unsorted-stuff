...
public class ShaderLoader {
    ...
    public void func_148056_a(ShaderManager p_148056_1_) {
        ++this.field_148058_d;
        GL20.glAttachShader((int)p_148056_1_.func_147986_h(), (int)this.field_148060_c);
    }

    public void func_148054_b(ShaderManager p_148054_1_) {
        --this.field_148058_d;
        if (this.field_148058_d <= 0) {
            GL20.glDeleteShader((int)this.field_148060_c);
    ...
    public static ShaderLoader func_148057_a(IResourceManager p_148057_0_, ShaderType p_148057_1_, String p_148057_2_) throws IOException {
        ...
        if (var3 == null) {
            ...
            byte[] var6 = IOUtils.toByteArray((InputStream)var5);
            ByteBuffer var7 = BufferUtils.createByteBuffer((int)var6.length);
            var7.put(var6);
            var7.position(0);
            int var8 = GL20.glCreateShader((int)p_148057_1_.func_148065_c());
            GL20.glShaderSource((int)var8, (ByteBuffer)var7);
            GL20.glCompileShader((int)var8);
            if (GL20.glGetShaderi((int)var8, (int)35713) == 0) {
                String var9 = StringUtils.trim((String)GL20.glGetShaderInfoLog((int)var8, (int)32768));
    ...
    public static enum ShaderType {
        ...
        private ShaderType(String p_i45090_1_, int p_i45090_2_, String p_i45090_3_, int p_i45090_4_, String p_i45090_5_, String string2, int n2) {
            ...
            this.field_148069_d = (String)p_i45090_4_;
