...
implements GuiListExtended.IGuiListEntry {
    ...
    public void func_148279_a(int p_148279_1_, int p_148279_2_, int p_148279_3_, int p_148279_4_, int p_148279_5_, Tessellator p_148279_6_, int p_148279_7_, int p_148279_8_, boolean p_148279_9_) {
        ...
        if ((var11 = this.field_148317_a.fontRenderer.getStringWidth(var14 = this.func_148312_b())) > 157) {
            var14 = String.valueOf(this.field_148317_a.fontRenderer.trimStringToWidth(var14, 157 - this.field_148317_a.fontRenderer.getStringWidth("..."))) + "...";
        }
        ...
        int var13 = 0;
        while (var13 < 2 && var13 < var12.size()) {
