...
extends TaskLongRunning {
    ...
    public void run() {
        ...
        boolean var7 = false;
        int var8 = 0;
        while (var8 < 10 && !this.func_148418_c()) {
            try {
                ...
                logger.error("Couldn't connect to world", (Throwable)var11);
                break;
            }
            catch (IOException var12) {
                logger.error("Couldn't parse response connecting to world", (Throwable)var12);
            }
        ...
        new Thread("MCO Connector #" + field_148439_a.incrementAndGet()){
            ...
            public void run() {
                try {
                    ...
                    TaskOnlineConnect.access$0(TaskOnlineConnect.this, NetworkManager.provideLanClient(InetAddress.getByName(p_148432_1_), p_148432_2_));
                    if (TaskOnlineConnect.this.func_148418_c()) {
                        return;
                    }
                    ...
                    logger.error("Couldn't connect to world", (Throwable)var2);
                    TaskOnlineConnect.this.func_148413_b().displayGuiScreen(new GuiScreenDisconnectedOnline(TaskOnlineConnect.this.field_148435_f, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", "Unknown host '" + p_148432_1_ + "'")));
                }
                catch (Exception var3) {
                    if (TaskOnlineConnect.this.func_148418_c()) {
                        return;
                    }
                    logger.error("Couldn't connect to world", (Throwable)var3);
                    TaskOnlineConnect.this.func_148413_b().displayGuiScreen(new GuiScreenDisconnectedOnline(TaskOnlineConnect.this.field_148435_f, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", var3.toString())));
                }
            }
        }.start();
    }
    ...
    static /* synthetic */ void access$0(TaskOnlineConnect taskOnlineConnect, NetworkManager networkManager) {
        taskOnlineConnect.field_148436_d = networkManager;
    }
