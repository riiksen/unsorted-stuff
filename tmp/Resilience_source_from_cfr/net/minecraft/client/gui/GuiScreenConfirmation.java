...
extends GuiScreen {
    ...
    public GuiScreenConfirmation(GuiScreen par1GuiScreen, ConfirmationType par2GuiScreenConfirmationType, String par3Str, String par4Str, int par5) {
    ...
    public static enum ConfirmationType {
        ...
        static {
            $VALUES = new ConfirmationType[]{Warning, Info};
        }

        private ConfirmationType(String par1Str, int par2, String par3Str, int par4, String string2, int n2) {
