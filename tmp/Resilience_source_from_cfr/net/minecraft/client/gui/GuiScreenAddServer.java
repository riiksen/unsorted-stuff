...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        ((GuiButton)this.buttonList.get((int)0)).enabled = this.field_146308_f.getText().length() > 0 && this.field_146308_f.getText().split(":").length > 0 && this.field_146309_g.getText().length() > 0;
    }
