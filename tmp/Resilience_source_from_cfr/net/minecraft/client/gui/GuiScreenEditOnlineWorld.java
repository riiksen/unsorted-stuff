...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.field_146860_s = new GuiButton(0, this.field_146859_t, this.height / 4 + 120 + 22, this.field_146858_u, 20, I18n.format("mco.configure.world.buttons.done", new Object[0]));
        this.buttonList.add(this.field_146860_s);
