...
public class McoClient {
    ...
    public ValueObjectList func_148703_a() throws ExceptionMcoService, IOException {
        String var1 = this.func_148713_a(Request.func_148666_a(String.valueOf(field_148716_e) + "worlds"));
    ...
    public McoServer func_148709_a(long p_148709_1_) throws ExceptionMcoService, IOException {
        String var3 = this.func_148713_a(Request.func_148666_a(String.valueOf(field_148716_e) + "worlds" + "/$ID".replace("$ID", String.valueOf(p_148709_1_))));
        return McoServer.func_148805_c(var3);
    }

    public McoServerAddress func_148688_b(long p_148688_1_) throws Exception {
        String var3 = String.valueOf(field_148716_e) + "worlds" + "/$ID/join".replace("$ID", new StringBuilder().append(p_148688_1_).toString());
    ...
    public Boolean func_148687_b() throws ExceptionMcoService, IOException {
        String var1 = String.valueOf(field_148716_e) + "mco" + "/available";
    ...
    public Boolean func_148695_c() throws ExceptionMcoService, IOException {
        String var1 = String.valueOf(field_148716_e) + "mco" + "/client/outdated";
        String var2 = this.func_148713_a(Request.func_148666_a(var1));
        return Boolean.valueOf(var2);
    }

    public int func_148702_d() throws ExceptionMcoService {
        String var1 = String.valueOf(field_148716_e) + "payments" + "/unused";
        String var2 = this.func_148713_a(Request.func_148666_a(var1));
        return Integer.valueOf(var2);
    }

    public void func_148694_a(long p_148694_1_, String p_148694_3_) throws ExceptionMcoService {
        String var4 = String.valueOf(field_148716_e) + "invites" + "/$WORLD_ID/invite/$USER_NAME".replace("$WORLD_ID", String.valueOf(p_148694_1_)).replace("$USER_NAME", p_148694_3_);
        this.func_148713_a(Request.func_148663_b(var4));
    }

    public void func_148698_c(long p_148698_1_) throws ExceptionMcoService {
        String var3 = String.valueOf(field_148716_e) + "invites" + "/$WORLD_ID".replace("$WORLD_ID", String.valueOf(p_148698_1_));
    ...
    public McoServer func_148697_b(long p_148697_1_, String p_148697_3_) throws ExceptionMcoService, IOException {
        String var4 = String.valueOf(field_148716_e) + "invites" + "/$WORLD_ID/invite/$USER_NAME".replace("$WORLD_ID", String.valueOf(p_148697_1_)).replace("$USER_NAME", p_148697_3_);
    ...
    public BackupList func_148704_d(long p_148704_1_) throws ExceptionMcoService {
        String var3 = String.valueOf(field_148716_e) + "worlds" + "/$WORLD_ID/backups".replace("$WORLD_ID", String.valueOf(p_148704_1_));
    ...
    public void func_148712_c(long p_148712_1_, String p_148712_3_) throws ExceptionMcoService {
        String var4 = String.valueOf(field_148716_e) + "worlds" + "/$WORLD_ID/backups".replace("$WORLD_ID", String.valueOf(p_148712_1_)) + "?backupId=" + p_148712_3_;
    ...
    public WorldTemplateList func_148693_e() throws ExceptionMcoService {
        String var1 = String.valueOf(field_148716_e) + "worlds" + "/templates";
        String var2 = this.func_148713_a(Request.func_148666_a(var1));
    ...
    public Boolean func_148692_e(long p_148692_1_) throws ExceptionMcoService, IOException {
        String var3 = String.valueOf(field_148716_e) + "worlds" + "/$WORLD_ID/open".replace("$WORLD_ID", String.valueOf(p_148692_1_));
    ...
    public Boolean func_148700_f(long p_148700_1_) throws ExceptionMcoService, IOException {
        String var3 = String.valueOf(field_148716_e) + "worlds" + "/$WORLD_ID/close".replace("$WORLD_ID", String.valueOf(p_148700_1_));
        String var4 = this.func_148713_a(Request.func_148668_d(var3, ""));
        return Boolean.valueOf(var4);
    }
    ...
    public ValueObjectSubscription func_148705_g(long p_148705_1_) throws ExceptionMcoService, IOException {
        String var3 = this.func_148713_a(Request.func_148666_a(String.valueOf(field_148716_e) + "subscriptions" + "/$WORLD_ID".replace("$WORLD_ID", String.valueOf(p_148705_1_))));
        return ValueObjectSubscription.func_148788_a(var3);
    }

    public int func_148701_f() throws ExceptionMcoService {
        String var1 = this.func_148713_a(Request.func_148666_a(String.valueOf(field_148716_e) + "invites" + "/count/pending"));
        return Integer.parseInt(var1);
    }

    public PendingInvitesList func_148710_g() throws ExceptionMcoService {
        String var1 = this.func_148713_a(Request.func_148666_a(String.valueOf(field_148716_e) + "invites" + "/pending"));
        return PendingInvitesList.func_148767_a(var1);
    }

    public void func_148691_a(String p_148691_1_) throws ExceptionMcoService {
        this.func_148713_a(Request.func_148668_d(String.valueOf(field_148716_e) + "invites" + "/accept/$INVITATION_ID".replace("$INVITATION_ID", p_148691_1_), ""));
    }

    public String func_148708_h(long p_148708_1_) throws ExceptionMcoService {
        return this.func_148713_a(Request.func_148666_a(String.valueOf(field_148716_e) + "worlds" + "/$WORLD_ID/backups/download".replace("$WORLD_ID", String.valueOf(p_148708_1_))));
    }

    public void func_148706_b(String p_148706_1_) throws ExceptionMcoService {
        this.func_148713_a(Request.func_148668_d(String.valueOf(field_148716_e) + "invites" + "/reject/$INVITATION_ID".replace("$INVITATION_ID", p_148706_1_), ""));
    }

    public void func_148714_h() throws ExceptionMcoService {
        this.func_148713_a(Request.func_148672_c(String.valueOf(field_148716_e) + "mco" + "/tos/agreed", ""));
    }

    public String func_148690_i() throws ExceptionMcoService {
        return this.func_148713_a(Request.func_148666_a(String.valueOf(field_148716_e) + "mco" + "/stat"));
    }
