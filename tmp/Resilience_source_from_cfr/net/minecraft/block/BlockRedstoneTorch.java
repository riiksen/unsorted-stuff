...
extends BlockTorch {
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
        ...
        while (var7 != null && !var7.isEmpty() && p_149674_1_.getTotalWorldTime() - ((Toggle)var7.get((int)0)).field_150844_d > 60) {
            var7.remove(0);
        }
        if (this.field_150113_a) {
            if (var6) {
                ...
                if (this.func_150111_a(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, true)) {
                    ...
                    int var8 = 0;
                    while (var8 < 5) {
                        double var9 = (double)p_149674_2_ + p_149674_5_.nextDouble() * 0.6 + 0.2;
                        double var11 = (double)p_149674_3_ + p_149674_5_.nextDouble() * 0.6 + 0.2;
                        double var13 = (double)p_149674_4_ + p_149674_5_.nextDouble() * 0.6 + 0.2;
                        p_149674_1_.spawnParticle("smoke", var9, var11, var13, 0.0, 0.0, 0.0);
                        ++var8;
                    }
                }
            }
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_) {
        if (this.field_150113_a) {
            ...
            double var7 = (double)((float)p_149734_2_ + 0.5f) + (double)(p_149734_5_.nextFloat() - 0.5f) * 0.2;
            double var9 = (double)((float)p_149734_3_ + 0.7f) + (double)(p_149734_5_.nextFloat() - 0.5f) * 0.2;
            double var11 = (double)((float)p_149734_4_ + 0.5f) + (double)(p_149734_5_.nextFloat() - 0.5f) * 0.2;
            double var13 = 0.2199999988079071;
            double var15 = 0.27000001072883606;
            if (var6 == 1) {
                p_149734_1_.spawnParticle("reddust", var7 - var15, var9 + var13, var11, 0.0, 0.0, 0.0);
            } else if (var6 == 2) {
                p_149734_1_.spawnParticle("reddust", var7 + var15, var9 + var13, var11, 0.0, 0.0, 0.0);
            } else if (var6 == 3) {
                p_149734_1_.spawnParticle("reddust", var7, var9 + var13, var11 - var15, 0.0, 0.0, 0.0);
            } else if (var6 == 4) {
                p_149734_1_.spawnParticle("reddust", var7, var9 + var13, var11 + var15, 0.0, 0.0, 0.0);
            } else {
                p_149734_1_.spawnParticle("reddust", var7, var9, var11, 0.0, 0.0, 0.0);
            }
        }
    }
    ...
    public boolean func_149667_c(Block p_149667_1_) {
        if (p_149667_1_ != Blocks.unlit_redstone_torch && p_149667_1_ != Blocks.redstone_torch) {
            return false;
        }
        return true;
    }
