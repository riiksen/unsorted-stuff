...
extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        this.field_149945_N = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_front_horizontal");
        this.field_149946_O = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_front_vertical");
    }
    ...
    public static IPosition func_149939_a(IBlockSource p_149939_0_) {
        EnumFacing var1 = BlockDispenser.func_149937_b(p_149939_0_.getBlockMetadata());
        double var2 = p_149939_0_.getX() + 0.7 * (double)var1.getFrontOffsetX();
        double var4 = p_149939_0_.getY() + 0.7 * (double)var1.getFrontOffsetY();
        double var6 = p_149939_0_.getZ() + 0.7 * (double)var1.getFrontOffsetZ();
