...
implements IGrowable {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        this.field_149991_b = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_top");
        this.field_149993_M = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_side_snowed");
        this.field_149994_N = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_side_overlay");
    }
        ...
        while (var6 < 128) {
            block8 : {
                ...
                for (int var10 = 0; var10 < var6 / 16; ++var10) {
                    if (p_149853_1_.getBlock(var7 += p_149853_2_.nextInt(3) - 1, (var8 += (p_149853_2_.nextInt(3) - 1) * p_149853_2_.nextInt(3) / 2) - 1, var9 += p_149853_2_.nextInt(3) - 1) == Blocks.grass && !p_149853_1_.getBlock(var7, var8, var9).isNormalCube()) {
                        continue;
                    }
                    break block8;
                }
                if (p_149853_1_.getBlock((int)var7, (int)var8, (int)var9).blockMaterial == Material.air) {
                    if (p_149853_2_.nextInt(8) != 0) {
                        ...
                        logger.debug("Flower in " + p_149853_1_.getBiomeGenForCoords((int)var7, (int)var9).biomeName + ": " + var13);
