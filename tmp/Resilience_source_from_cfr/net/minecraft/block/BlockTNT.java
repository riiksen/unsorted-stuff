...
extends Block {
    ...
    public void onEntityCollidedWithBlock(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity p_149670_5_) {
        EntityArrow var6;
        if (p_149670_5_ instanceof EntityArrow && !p_149670_1_.isClient && (var6 = (EntityArrow)p_149670_5_).isBurning()) {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        this.field_150116_a = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_top");
        this.field_150115_b = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_bottom");
    }
}
