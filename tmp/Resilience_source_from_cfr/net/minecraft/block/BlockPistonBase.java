...
extends Block {
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
        int var3 = BlockPistonBase.func_150076_b(p_149691_2_);
        return var3 > 5 ? this.field_150084_N : (p_149691_1_ == var3 ? (!BlockPistonBase.func_150075_c(p_149691_2_) && this.field_149759_B <= 0.0 && this.field_149760_C <= 0.0 && this.field_149754_D <= 0.0 && this.field_149755_E >= 1.0 && this.field_149756_F >= 1.0 && this.field_149757_G >= 1.0 ? this.field_150084_N : this.field_150081_b) : (p_149691_1_ == Facing.oppositeSide[var3] ? this.field_150083_M : this.blockIcon));
    }
    ...
    private void func_150078_e(World p_150078_1_, int p_150078_2_, int p_150078_3_, int p_150078_4_) {
        ...
        int var6 = BlockPistonBase.func_150076_b(var5);
        if (var6 != 7) {
            boolean var7 = this.func_150072_a(p_150078_1_, p_150078_2_, p_150078_3_, p_150078_4_, var6);
            if (var7 && !BlockPistonBase.func_150075_c(var5)) {
                if (BlockPistonBase.func_150077_h(p_150078_1_, p_150078_2_, p_150078_3_, p_150078_4_, var6)) {
                    p_150078_1_.func_147452_c(p_150078_2_, p_150078_3_, p_150078_4_, this, 0, var6);
                }
            } else if (!var7 && BlockPistonBase.func_150075_c(var5)) {
    ...
    public boolean onBlockEventReceived(World p_149696_1_, int p_149696_2_, int p_149696_3_, int p_149696_4_, int p_149696_5_, int p_149696_6_) {
        ...
        if (p_149696_5_ == 0) {
            ...
            p_149696_1_.setBlockMetadataWithNotify(p_149696_2_, p_149696_3_, p_149696_4_, p_149696_6_ | 8, 2);
            p_149696_1_.playSoundEffect((double)p_149696_2_ + 0.5, (double)p_149696_3_ + 0.5, (double)p_149696_4_ + 0.5, "tile.piston.out", 0.5f, p_149696_1_.rand.nextFloat() * 0.25f + 0.6f);
            ...
            if (this.field_150082_a) {
                ...
                boolean var13 = false;
                if (var11 == Blocks.piston_extension && (var14 = p_149696_1_.getTileEntity(var8, var9, var10)) instanceof TileEntityPiston && (var15 = (TileEntityPiston)var14).func_145864_c() == p_149696_6_ && var15.func_145868_b()) {
                    var15.func_145866_f();
                    var11 = var15.func_145861_a();
                    var12 = var15.getBlockMetadata();
                    var13 = true;
                }
                if (!var13 && var11.getMaterial() != Material.air && BlockPistonBase.func_150080_a(var11, p_149696_1_, var8, var9, var10, false) && (var11.getMobilityFlag() == 0 || var11 == Blocks.piston || var11 == Blocks.sticky_piston)) {
                    p_149696_1_.setBlock(p_149696_2_ += Facing.offsetsXForSide[p_149696_6_], p_149696_3_ += Facing.offsetsYForSide[p_149696_6_], p_149696_4_ += Facing.offsetsZForSide[p_149696_6_], Blocks.piston_extension, var12, 3);
            ...
            p_149696_1_.playSoundEffect((double)p_149696_2_ + 0.5, (double)p_149696_3_ + 0.5, (double)p_149696_4_ + 0.5, "tile.piston.in", 0.5f, p_149696_1_.rand.nextFloat() * 0.15f + 0.6f);
        }
        return true;
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess p_149719_1_, int p_149719_2_, int p_149719_3_, int p_149719_4_) {
        ...
        if (BlockPistonBase.func_150075_c(var5)) {
            float var6 = 0.25f;
            switch (BlockPistonBase.func_150076_b(var5)) {
                case 0: {
    ...
    public static int func_150071_a(World p_150071_0_, int p_150071_1_, int p_150071_2_, int p_150071_3_, EntityLivingBase p_150071_4_) {
        ...
        if (MathHelper.abs((float)p_150071_4_.posX - (float)p_150071_1_) < 2.0f && MathHelper.abs((float)p_150071_4_.posZ - (float)p_150071_3_) < 2.0f) {
            double var5 = p_150071_4_.posY + 1.82 - (double)p_150071_4_.yOffset;
            if (var5 - (double)p_150071_2_ > 2.0) {
                return 1;
            }
            if ((double)p_150071_2_ - var5 > 0.0) {
                return 0;
            }
        }
        return (var7 = MathHelper.floor_double((double)(p_150071_4_.rotationYaw * 4.0f / 360.0f) + 0.5) & 3) == 0 ? 2 : (var7 == 1 ? 5 : (var7 == 2 ? 3 : (var7 == 3 ? 4 : 0)));
    }
    ...
    private static boolean func_150080_a(Block p_150080_0_, World p_150080_1_, int p_150080_2_, int p_150080_3_, int p_150080_4_, boolean p_150080_5_) {
        ...
        } else if (BlockPistonBase.func_150075_c(p_150080_1_.getBlockMetadata(p_150080_2_, p_150080_3_, p_150080_4_))) {
            return false;
        }
    ...
    private static boolean func_150077_h(World p_150077_0_, int p_150077_1_, int p_150077_2_, int p_150077_3_, int p_150077_4_) {
        ...
        for (int var8 = 0; var8 < 13; ++var8) {
            ...
            if (var9.getMaterial() == Material.air) break;
            if (!BlockPistonBase.func_150080_a(var9, p_150077_0_, var5, var6, var7, true)) {
                return false;
            }
            if (var9.getMobilityFlag() == 1) break;
            if (var8 == 12) {
                return false;
            }
    ...
    private boolean func_150079_i(World p_150079_1_, int p_150079_2_, int p_150079_3_, int p_150079_4_, int p_150079_5_) {
        ...
        for (var9 = 0; var9 < 13; ++var9) {
            ...
            if (var10.getMaterial() == Material.air) break;
            if (!BlockPistonBase.func_150080_a(var10, p_150079_1_, var6, var7, var8, true)) {
                return false;
            }
