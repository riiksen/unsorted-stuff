...
extends Block {
    ...
    public int onBlockPlaced(World p_149660_1_, int p_149660_2_, int p_149660_3_, int p_149660_4_, int p_149660_5_, float p_149660_6_, float p_149660_7_, float p_149660_8_, int p_149660_9_) {
        ...
        int var11 = var10 & 8;
        var10 &= 7;
        var10 = p_149660_5_ == 2 && p_149660_1_.getBlock(p_149660_2_, p_149660_3_, p_149660_4_ + 1).isNormalCube() ? 4 : (p_149660_5_ == 3 && p_149660_1_.getBlock(p_149660_2_, p_149660_3_, p_149660_4_ - 1).isNormalCube() ? 3 : (p_149660_5_ == 4 && p_149660_1_.getBlock(p_149660_2_ + 1, p_149660_3_, p_149660_4_).isNormalCube() ? 2 : (p_149660_5_ == 5 && p_149660_1_.getBlock(p_149660_2_ - 1, p_149660_3_, p_149660_4_).isNormalCube() ? 1 : this.func_150045_e(p_149660_1_, p_149660_2_, p_149660_3_, p_149660_4_))));
        return var10 + var11;
    }
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        ...
        p_149727_1_.playSoundEffect((double)p_149727_2_ + 0.5, (double)p_149727_3_ + 0.5, (double)p_149727_4_ + 0.5, "random.click", 0.3f, 0.6f);
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
        ...
        if (!p_149674_1_.isClient && ((var6 = p_149674_1_.getBlockMetadata(p_149674_2_, p_149674_3_, p_149674_4_)) & 8) != 0) {
            if (this.field_150047_a) {
                ...
                p_149674_1_.playSoundEffect((double)p_149674_2_ + 0.5, (double)p_149674_3_ + 0.5, (double)p_149674_4_ + 0.5, "random.click", 0.3f, 0.5f);
    ...
    public void onEntityCollidedWithBlock(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity p_149670_5_) {
        if (!p_149670_1_.isClient && this.field_150047_a && (p_149670_1_.getBlockMetadata(p_149670_2_, p_149670_3_, p_149670_4_) & 8) == 0) {
    ...
    private void func_150046_n(World p_150046_1_, int p_150046_2_, int p_150046_3_, int p_150046_4_) {
        ...
        if (var8 && !var7) {
            ...
            p_150046_1_.playSoundEffect((double)p_150046_2_ + 0.5, (double)p_150046_3_ + 0.5, (double)p_150046_4_ + 0.5, "random.click", 0.3f, 0.6f);
        }
        if (!var8 && var7) {
            p_150046_1_.setBlockMetadataWithNotify(p_150046_2_, p_150046_3_, p_150046_4_, var6, 3);
            this.func_150042_a(p_150046_1_, p_150046_2_, p_150046_3_, p_150046_4_, var6);
            p_150046_1_.markBlockRangeForRenderUpdate(p_150046_2_, p_150046_3_, p_150046_4_, p_150046_2_, p_150046_3_, p_150046_4_);
            p_150046_1_.playSoundEffect((double)p_150046_2_ + 0.5, (double)p_150046_3_ + 0.5, (double)p_150046_4_ + 0.5, "random.click", 0.3f, 0.5f);
        }
        if (var8) {
