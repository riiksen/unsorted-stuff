...
extends Block {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        int var2 = 0;
        while (var2 < this.field_150158_M.length) {
            this.field_150158_M[var2] = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_" + field_150156_b[var2]);
            ++var2;
        }
        this.field_150159_N = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_top");
        this.field_150160_O = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_bottom");
    }
}
