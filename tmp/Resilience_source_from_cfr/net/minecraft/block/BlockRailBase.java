...
extends Block {
    ...
    public static final boolean func_150049_b_(World p_150049_0_, int p_150049_1_, int p_150049_2_, int p_150049_3_) {
        return BlockRailBase.func_150051_a(p_150049_0_.getBlock(p_150049_1_, p_150049_2_, p_150049_3_));
    }

    public static final boolean func_150051_a(Block p_150051_0_) {
        if (p_150051_0_ != Blocks.rail && p_150051_0_ != Blocks.golden_rail && p_150051_0_ != Blocks.detector_rail && p_150051_0_ != Blocks.activator_rail) {
            return false;
        }
        return true;
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_) {
        if (!p_149695_1_.isClient) {
            int var6;
            int var7 = var6 = p_149695_1_.getBlockMetadata(p_149695_2_, p_149695_3_, p_149695_4_);
            if (this.field_150053_a) {
                var7 = var6 & 7;
            }
            boolean var8 = false;
    ...
    public class Rail {
        ...
        private Rail func_150654_a(ChunkPosition p_150654_1_) {
            Rail rail;
            if (BlockRailBase.func_150049_b_(this.field_150660_b, p_150654_1_.field_151329_a, p_150654_1_.field_151327_b, p_150654_1_.field_151328_c)) {
                BlockRailBase blockRailBase;
                rail = blockRailBase.new Rail(this.field_150660_b, p_150654_1_.field_151329_a, p_150654_1_.field_151327_b, p_150654_1_.field_151328_c);
                blockRailBase = BlockRailBase.this;
                blockRailBase.getClass();
            } else if (BlockRailBase.func_150049_b_(this.field_150660_b, p_150654_1_.field_151329_a, p_150654_1_.field_151327_b + 1, p_150654_1_.field_151328_c)) {
                BlockRailBase blockRailBase;
                rail = blockRailBase.new Rail(this.field_150660_b, p_150654_1_.field_151329_a, p_150654_1_.field_151327_b + 1, p_150654_1_.field_151328_c);
                blockRailBase = BlockRailBase.this;
                blockRailBase.getClass();
            } else if (BlockRailBase.func_150049_b_(this.field_150660_b, p_150654_1_.field_151329_a, p_150654_1_.field_151327_b - 1, p_150654_1_.field_151328_c)) {
                BlockRailBase blockRailBase;
        ...
        private boolean func_150652_b(int p_150652_1_, int p_150652_2_, int p_150652_3_) {
            int var4 = 0;
            while (var4 < this.field_150657_g.size()) {
        ...
        public void func_150655_a(boolean p_150655_1_, boolean p_150655_2_) {
            ...
            if (p_150655_2_ || this.field_150660_b.getBlockMetadata(this.field_150661_c, this.field_150658_d, this.field_150659_e) != var8) {
                ...
                int var9 = 0;
                while (var9 < this.field_150657_g.size()) {
