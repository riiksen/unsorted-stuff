...
extends Block {
        ...
        if (p_149673_5_ != 1 && p_149673_5_ != 0) {
            ...
            if (var8) {
                ...
                if (var7 == 0 && p_149673_5_ == 5) {
                    ...
                    boolean bl2 = var9 = !var9;
                }
                if ((var6 & 16) != 0) {
                    boolean bl3 = var9 = !var9;
                }
            }
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        this.field_150017_a[0] = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_upper");
        this.field_150016_b[0] = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_lower");
    ...
    public boolean func_150015_f(IBlockAccess p_150015_1_, int p_150015_2_, int p_150015_3_, int p_150015_4_) {
        if ((this.func_150012_g(p_150015_1_, p_150015_2_, p_150015_3_, p_150015_4_) & 4) != 0) {
            return true;
        }
        return false;
    }
    ...
    private void func_150011_b(int p_150011_1_) {
        ...
        boolean bl = var5 = (p_150011_1_ & 16) != 0;
        if (var3 == 0) {
            if (var4) {
                if (!var5) {
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_) {
        ...
        if ((var6 & 8) == 0) {
            ...
            if (var7) {
                ...
                boolean var8;
                boolean bl = var8 = p_149695_1_.isBlockIndirectlyGettingPowered(p_149695_2_, p_149695_3_, p_149695_4_) || p_149695_1_.isBlockIndirectlyGettingPowered(p_149695_2_, p_149695_3_ + 1, p_149695_4_);
