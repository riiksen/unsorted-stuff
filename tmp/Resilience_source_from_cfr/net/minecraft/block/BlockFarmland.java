...
extends Block {
    ...
    private boolean func_149822_e(World p_149822_1_, int p_149822_2_, int p_149822_3_, int p_149822_4_) {
        int var5 = 0;
        int var6 = p_149822_2_ - var5;
        while (var6 <= p_149822_2_ + var5) {
            int var7 = p_149822_4_ - var5;
            while (var7 <= p_149822_4_ + var5) {
    ...
    private boolean func_149821_m(World p_149821_1_, int p_149821_2_, int p_149821_3_, int p_149821_4_) {
        int var5 = p_149821_2_ - 4;
        while (var5 <= p_149821_2_ + 4) {
            int var6 = p_149821_3_;
            while (var6 <= p_149821_3_ + 1) {
                int var7 = p_149821_4_ - 4;
                while (var7 <= p_149821_4_ + 4) {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        this.field_149824_a = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_wet");
        this.field_149823_b = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_dry");
    }
}
