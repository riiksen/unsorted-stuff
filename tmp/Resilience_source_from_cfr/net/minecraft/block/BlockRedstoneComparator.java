...
implements ITileEntityProvider {
    ...
    public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
        boolean var3;
        boolean bl = var3 = this.field_149914_a || (p_149691_2_ & 8) != 0;
    ...
    protected boolean func_149905_c(int p_149905_1_) {
        if (!this.field_149914_a && (p_149905_1_ & 8) == 0) {
            return false;
        }
        return true;
    }
    ...
    protected int func_149903_h(World p_149903_1_, int p_149903_2_, int p_149903_3_, int p_149903_4_, int p_149903_5_) {
        ...
        int var7 = BlockRedstoneComparator.func_149895_l(p_149903_5_);
        int var8 = p_149903_2_ + Direction.offsetX[var7];
        Block var10 = p_149903_1_.getBlock(var8, p_149903_3_, var9 = p_149903_4_ + Direction.offsetZ[var7]);
        ...
        } else if (var6 < 15 && var10.isNormalCube() && (var10 = p_149903_1_.getBlock(var8 += Direction.offsetX[var7], p_149903_3_, var9 += Direction.offsetZ[var7])).hasComparatorInputOverride()) {
            var6 = var10.getComparatorInputOverride(p_149903_1_, var8, p_149903_3_, var9, Direction.rotateOpposite[var7]);
        }
        return var6;
    }
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        ...
        int var13 = var12 ? 4 : 0;
        p_149727_1_.playSoundEffect((double)p_149727_2_ + 0.5, (double)p_149727_3_ + 0.5, (double)p_149727_4_ + 0.5, "random.click", 0.3f, var12 ? 0.55f : 0.5f);
        p_149727_1_.setBlockMetadataWithNotify(p_149727_2_, p_149727_3_, p_149727_4_, (var13 |= var11 ? 8 : 0) | var10 & 3, 2);
    ...
    private void func_149972_c(World p_149972_1_, int p_149972_2_, int p_149972_3_, int p_149972_4_, Random p_149972_5_) {
        ...
        if (var8 != var7 || !this.func_149969_d(var6)) {
            ...
            boolean bl = var10 = this.field_149914_a || (var6 & 8) != 0;
            if (var10 && !var9) {
