...
extends Block {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        int var2 = 0;
        while (var2 < this.field_149794_M.length) {
            this.field_149794_M[var2] = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_" + field_149793_a[var2]);
            ++var2;
        }
        this.field_149796_O = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_" + "inside");
        this.field_149795_N = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_" + "skin_stem");
    }
}
