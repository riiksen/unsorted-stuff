...
extends Block {
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_) {
        ...
        int var8 = var7 & 7;
        int var9 = var7 & 8;
        if (var8 == BlockLever.func_149819_b(1)) {
            if ((MathHelper.floor_double((double)(p_149689_5_.rotationYaw * 4.0f / 360.0f) + 0.5) & 1) == 0) {
        ...
        } else if (var8 == BlockLever.func_149819_b(0)) {
            if ((MathHelper.floor_double((double)(p_149689_5_.rotationYaw * 4.0f / 360.0f) + 0.5) & 1) == 0) {
                p_149689_1_.setBlockMetadataWithNotify(p_149689_2_, p_149689_3_, p_149689_4_, 7 | var9, 2);
            } else {
                p_149689_1_.setBlockMetadataWithNotify(p_149689_2_, p_149689_3_, p_149689_4_, var9, 2);
            }
        }
    }
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
        ...
        p_149727_1_.playSoundEffect((double)p_149727_2_ + 0.5, (double)p_149727_3_ + 0.5, (double)p_149727_4_ + 0.5, "random.click", 0.3f, var12 > 0 ? 0.6f : 0.5f);
