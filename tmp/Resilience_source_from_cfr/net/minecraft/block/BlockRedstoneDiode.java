...
extends BlockDirectional {
    ...
    public boolean shouldSideBeRendered(IBlockAccess p_149646_1_, int p_149646_2_, int p_149646_3_, int p_149646_4_, int p_149646_5_) {
        if (p_149646_5_ != 0 && p_149646_5_ != 1) {
            return true;
        }
        return false;
    }
    ...
    public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_, int p_149709_5_) {
        ...
        int var7 = BlockRedstoneDiode.func_149895_l(var6);
    ...
    protected boolean func_149900_a(World p_149900_1_, int p_149900_2_, int p_149900_3_, int p_149900_4_, int p_149900_5_) {
        if (this.func_149903_h(p_149900_1_, p_149900_2_, p_149900_3_, p_149900_4_, p_149900_5_) > 0) {
            return true;
        }
        return false;
    }
    ...
    protected int func_149903_h(World p_149903_1_, int p_149903_2_, int p_149903_3_, int p_149903_4_, int p_149903_5_) {
        int var8;
        int var6 = BlockRedstoneDiode.func_149895_l(p_149903_5_);
        int var7 = p_149903_2_ + Direction.offsetX[var6];
        int var9 = p_149903_1_.getIndirectPowerLevelTo(var7, p_149903_3_, var8 = p_149903_4_ + Direction.offsetZ[var6], Direction.directionToFacing[var6]);
    ...
    protected int func_149902_h(IBlockAccess p_149902_1_, int p_149902_2_, int p_149902_3_, int p_149902_4_, int p_149902_5_) {
        int var6 = BlockRedstoneDiode.func_149895_l(p_149902_5_);
        switch (var6) {
            case 0: 
            case 2: {
    ...
    protected void func_149911_e(World p_149911_1_, int p_149911_2_, int p_149911_3_, int p_149911_4_) {
        int var5 = BlockRedstoneDiode.func_149895_l(p_149911_1_.getBlockMetadata(p_149911_2_, p_149911_3_, p_149911_4_));
        if (var5 == 1) {
    ...
    public boolean func_149907_e(Block p_149907_1_) {
        if (p_149907_1_ != this.func_149906_e() && p_149907_1_ != this.func_149898_i()) {
            return false;
        }
        return true;
    }
    ...
    public boolean func_149912_i(World p_149912_1_, int p_149912_2_, int p_149912_3_, int p_149912_4_, int p_149912_5_) {
        int var6 = BlockRedstoneDiode.func_149895_l(p_149912_5_);
        if (BlockRedstoneDiode.func_149909_d(p_149912_1_.getBlock(p_149912_2_ - Direction.offsetX[var6], p_149912_3_, p_149912_4_ - Direction.offsetZ[var6]))) {
            int var7 = p_149912_1_.getBlockMetadata(p_149912_2_ - Direction.offsetX[var6], p_149912_3_, p_149912_4_ - Direction.offsetZ[var6]);
            int var8 = BlockRedstoneDiode.func_149895_l(var7);
            if (var8 != var6) {
                return true;
            }
            return false;
