...
extends BlockContainer {
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_) {
        ...
        int var11 = 0;
        int var12 = MathHelper.floor_double((double)(p_149689_5_.rotationYaw * 4.0f / 360.0f) + 0.5) & 3;
        if (var12 == 0) {
            var11 = 2;
        }
        if (var12 == 1) {
        ...
        if (!p_149954_1_.isClient) {
            ...
            if (var5 != this && var6 != this) {
                if (var7 != this && var8 != this) {
                    ...
                    int var10 = var7 == this ? p_149954_2_ - 1 : p_149954_2_ + 1;
                    Block var11 = p_149954_1_.getBlock(var10, p_149954_3_, p_149954_4_ - 1);
                    int var12 = var7 == this ? p_149954_2_ - 1 : p_149954_2_ + 1;
                    Block var13 = p_149954_1_.getBlock(var12, p_149954_3_, p_149954_4_ + 1);
                    var15 = 3;
                    boolean var14 = true;
                    int var16 = var7 == this ? p_149954_1_.getBlockMetadata(p_149954_2_ - 1, p_149954_3_, p_149954_4_) : p_149954_1_.getBlockMetadata(p_149954_2_ + 1, p_149954_3_, p_149954_4_);
                    if (var16 == 2) {
                        var15 = 2;
                    }
                ...
                int var10 = var5 == this ? p_149954_4_ - 1 : p_149954_4_ + 1;
                Block var11 = p_149954_1_.getBlock(p_149954_2_ - 1, p_149954_3_, var10);
                int var12 = var5 == this ? p_149954_4_ - 1 : p_149954_4_ + 1;
                Block var13 = p_149954_1_.getBlock(p_149954_2_ + 1, p_149954_3_, var12);
                var15 = 5;
                boolean var14 = true;
                int var16 = var5 == this ? p_149954_1_.getBlockMetadata(p_149954_2_, p_149954_3_, p_149954_4_ - 1) : p_149954_1_.getBlockMetadata(p_149954_2_, p_149954_3_, p_149954_4_ + 1);
                if (var16 == 4) {
                    var15 = 4;
                }
    ...
    public IInventory func_149951_m(World p_149951_1_, int p_149951_2_, int p_149951_3_, int p_149951_4_) {
        IInventory var5 = (TileEntityChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
        if (var5 == null) {
            return null;
        }
        ...
        if (BlockChest.func_149953_o(p_149951_1_, p_149951_2_, p_149951_3_, p_149951_4_)) {
            return null;
        }
        if (p_149951_1_.getBlock(p_149951_2_ - 1, p_149951_3_, p_149951_4_) == this && (p_149951_1_.getBlock(p_149951_2_ - 1, p_149951_3_ + 1, p_149951_4_).isNormalCube() || BlockChest.func_149953_o(p_149951_1_, p_149951_2_ - 1, p_149951_3_, p_149951_4_))) {
            return null;
        }
        if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this && (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_ + 1, p_149951_4_).isNormalCube() || BlockChest.func_149953_o(p_149951_1_, p_149951_2_ + 1, p_149951_3_, p_149951_4_))) {
            return null;
        }
        if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this && (p_149951_1_.getBlock(p_149951_2_, p_149951_3_ + 1, p_149951_4_ - 1).isNormalCube() || BlockChest.func_149953_o(p_149951_1_, p_149951_2_, p_149951_3_, p_149951_4_ - 1))) {
            return null;
        }
        if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this && (p_149951_1_.getBlock(p_149951_2_, p_149951_3_ + 1, p_149951_4_ + 1).isNormalCube() || BlockChest.func_149953_o(p_149951_1_, p_149951_2_, p_149951_3_, p_149951_4_ + 1))) {
            return null;
        ...
        if (p_149951_1_.getBlock(p_149951_2_ - 1, p_149951_3_, p_149951_4_) == this) {
            var5 = new InventoryLargeChest("container.chestDouble", (TileEntityChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), var5);
        }
        if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this) {
            var5 = new InventoryLargeChest("container.chestDouble", var5, (TileEntityChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
        }
        if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this) {
            var5 = new InventoryLargeChest("container.chestDouble", (TileEntityChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), var5);
        }
        if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this) {
            var5 = new InventoryLargeChest("container.chestDouble", var5, (TileEntityChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
        }
        return var5;
    }
    ...
    public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_, int p_149709_5_) {
        ...
        int var6 = ((TileEntityChest)p_149709_1_.getTileEntity((int)p_149709_2_, (int)p_149709_3_, (int)p_149709_4_)).field_145987_o;
    ...
    private static boolean func_149953_o(World p_149953_0_, int p_149953_1_, int p_149953_2_, int p_149953_3_) {
        ...
        do {
            ...
            return false;
        } while (!(var6 = (var5 = (EntityOcelot)var4.next())).isSitting());
        return true;
    }
