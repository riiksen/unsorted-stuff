...
extends BlockContainer {
    ...
    public void func_149926_b(World p_149926_1_, int p_149926_2_, int p_149926_3_, int p_149926_4_, ItemStack p_149926_5_) {
        TileEntityJukebox var6;
        if (!p_149926_1_.isClient && (var6 = (TileEntityJukebox)p_149926_1_.getTileEntity(p_149926_2_, p_149926_3_, p_149926_4_)) != null) {
    ...
    public void func_149925_e(World p_149925_1_, int p_149925_2_, int p_149925_3_, int p_149925_4_) {
        ...
        if (!p_149925_1_.isClient && (var5 = (TileEntityJukebox)p_149925_1_.getTileEntity(p_149925_2_, p_149925_3_, p_149925_4_)) != null && (var6 = var5.func_145856_a()) != null) {
            ...
            float var7 = 0.7f;
            double var8 = (double)(p_149925_1_.rand.nextFloat() * var7) + (double)(1.0f - var7) * 0.5;
            double var10 = (double)(p_149925_1_.rand.nextFloat() * var7) + (double)(1.0f - var7) * 0.2 + 0.6;
            double var12 = (double)(p_149925_1_.rand.nextFloat() * var7) + (double)(1.0f - var7) * 0.5;
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        this.field_149927_a = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_top");
    }
