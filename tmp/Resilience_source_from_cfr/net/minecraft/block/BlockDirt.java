...
extends Block {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        this.field_150008_b = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_" + "podzol_top");
        this.field_150010_M = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_" + "podzol_side");
    }
