...
extends Block {
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_) {
        ...
        boolean bl = var8 = !World.doesBlockHaveSolidTopSurface(p_149695_1_, p_149695_2_, p_149695_3_ - 1, p_149695_4_);
        if (var7 != var8) {
        ...
        while (var6 < 2) {
            for (int var7 = 1; var7 < 42; ++var7) {
                ...
                if (var10 == Blocks.tripwire_hook) {
                    ...
                    if (var11 != Direction.rotateOpposite[var6]) break;
                ...
                if (var10 != Blocks.tripwire) break;
            }
            ++var6;
        }
    }
    ...
    public void onEntityCollidedWithBlock(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity p_149670_5_) {
        if (!p_149670_1_.isClient && (p_149670_1_.getBlockMetadata(p_149670_2_, p_149670_3_, p_149670_4_) & 1) != 1) {
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
        if (!p_149674_1_.isClient && (p_149674_1_.getBlockMetadata(p_149674_2_, p_149674_3_, p_149674_4_) & 1) == 1) {
    ...
    private void func_150140_e(World p_150140_1_, int p_150140_2_, int p_150140_3_, int p_150140_4_) {
        ...
        boolean var7 = false;
        List var8 = p_150140_1_.getEntitiesWithinAABBExcludingEntity(null, AxisAlignedBB.getAABBPool().getAABB((double)p_150140_2_ + this.field_149759_B, (double)p_150140_3_ + this.field_149760_C, (double)p_150140_4_ + this.field_149754_D, (double)p_150140_2_ + this.field_149755_E, (double)p_150140_3_ + this.field_149756_F, (double)p_150140_4_ + this.field_149757_G));
        if (!var8.isEmpty()) {
    ...
    public static boolean func_150139_a(IBlockAccess p_150139_0_, int p_150139_1_, int p_150139_2_, int p_150139_3_, int p_150139_4_, int p_150139_5_) {
        ...
        boolean bl = var10 = (p_150139_4_ & 2) == 2;
        if (var9 == Blocks.tripwire_hook) {
            int var11 = p_150139_0_.getBlockMetadata(var6, p_150139_2_, var8);
            int var13 = var11 & 3;
            if (var13 == Direction.rotateOpposite[p_150139_5_]) {
                return true;
            }
            return false;
        }
        if (var9 == Blocks.tripwire) {
            boolean var12;
            int var11 = p_150139_0_.getBlockMetadata(var6, p_150139_2_, var8);
            boolean bl2 = var12 = (var11 & 2) == 2;
            if (var10 == var12) {
                return true;
            }
            return false;
