...
implements IGrowable {
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
        ...
        if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) >= 9 && p_149674_5_.nextInt((int)(25.0f / (var6 = this.func_149875_n(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_))) + 1) == 0) {
            ...
            if (var7 < 7) {
                ...
                if (p_149674_1_.getBlock((int)var9, (int)p_149674_3_, (int)var10).blockMaterial == Material.air && (var11 == Blocks.farmland || var11 == Blocks.dirt || var11 == Blocks.grass)) {
    ...
    private float func_149875_n(World p_149875_1_, int p_149875_2_, int p_149875_3_, int p_149875_4_) {
        ...
        int var17 = p_149875_2_ - 1;
        while (var17 <= p_149875_2_ + 1) {
            int var18 = p_149875_4_ - 1;
            while (var18 <= p_149875_4_ + 1) {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        this.blockIcon = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_disconnected");
        this.field_149876_b = p_149651_1_.registerIcon(String.valueOf(this.getTextureName()) + "_connected");
    }
