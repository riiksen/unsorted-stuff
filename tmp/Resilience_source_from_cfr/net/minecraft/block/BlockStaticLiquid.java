...
extends BlockLiquid {
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
        if (this.blockMaterial == Material.lava) {
            ...
            int var7 = 0;
            while (var7 < var6) {
                Block var8 = p_149674_1_.getBlock(p_149674_2_ += p_149674_5_.nextInt(3) - 1, ++p_149674_3_, p_149674_4_ += p_149674_5_.nextInt(3) - 1);
            ...
            if (var6 == 0) {
                ...
                while (var9 < 3) {
                    ...
                    if (p_149674_1_.isAirBlock(p_149674_2_, p_149674_3_ + 1, p_149674_4_ = var10 + p_149674_5_.nextInt(3) - 1) && this.isFlammable(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_)) {
