...
public class MerchantRecipe {
    ...
    public boolean hasSameItemsAs(MerchantRecipe par1MerchantRecipe) {
        if (this.hasSameIDsAs(par1MerchantRecipe) && (this.itemToBuy.stackSize < par1MerchantRecipe.itemToBuy.stackSize || this.secondItemToBuy != null && this.secondItemToBuy.stackSize < par1MerchantRecipe.secondItemToBuy.stackSize)) {
            return true;
        }
        return false;
    }
    ...
    public void readFromTags(NBTTagCompound par1NBTTagCompound) {
        ...
        this.maxTradeUses = par1NBTTagCompound.func_150297_b("maxUses", 99) ? par1NBTTagCompound.getInteger("maxUses") : 7;
    }
