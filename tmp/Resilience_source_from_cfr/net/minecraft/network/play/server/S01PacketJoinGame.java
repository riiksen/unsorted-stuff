...
extends Packet {
    ...
    public String serialize() {
        return String.format("eid=%d, gameType=%d, hardcore=%b, dimension=%d, difficulty=%s, maxplayers=%d", new Object[]{this.field_149206_a, this.field_149205_c.getID(), this.field_149204_b, this.field_149202_d, this.field_149203_e, this.field_149200_f});
    }
