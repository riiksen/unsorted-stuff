...
extends Packet {
    ...
    public S26PacketMapChunkBulk(List p_i45197_1_) {
        ...
        this.field_149267_h = !p_i45197_1_.isEmpty() && !((Chunk)p_i45197_1_.get((int)0)).worldObj.provider.hasNoSky;
        int var3 = 0;
        int var4 = 0;
        while (var4 < var2) {
    ...
    public void readPacketData(PacketBuffer p_148837_1_) throws IOException {
        ...
        var3 = new byte[S21PacketChunkData.func_149275_c() * var2];
