...
extends Packet {
    ...
    public String serialize() {
        return String.format("invuln=%b, flying=%b, canfly=%b, instabuild=%b, flyspeed=%.4f, walkspped=%.4f", this.func_149112_c(), this.func_149106_d(), this.func_149105_e(), this.func_149103_f(), Float.valueOf(this.func_149101_g()), Float.valueOf(this.func_149107_h()));
    }
