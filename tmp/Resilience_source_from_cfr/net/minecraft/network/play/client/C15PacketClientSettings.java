...
extends Packet {
    ...
    public String serialize() {
        return String.format("lang='%s', view=%d, chat=%s, col=%b, difficulty=%s, cape=%b", new Object[]{this.field_149530_a, this.field_149528_b, this.field_149529_c, this.field_149526_d, this.field_149527_e, this.field_149525_f});
    }
