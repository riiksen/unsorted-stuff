...
public enum EnumConnectionState {
    ...
    static {
        field_150764_e = new TIntObjectHashMap();
        ...
        while (var2 < var1) {
            ...
            field_150764_e.put(var3.func_150759_c(), (Object)var3);
            for (Class var5 : Iterables.concat((Iterable)var3.func_150755_b().values(), (Iterable)var3.func_150753_a().values())) {
                if (field_150761_f.containsKey(var5) && field_150761_f.get(var5) != var3) {
                    throw new Error("Packet " + var5 + " is already assigned to protocol " + field_150761_f.get(var5) + " - can't reassign to " + (Object)((Object)var3));
                }
    ...
    private EnumConnectionState(String p_i45152_3_, int n2, int n3) {
    ...
    protected EnumConnectionState func_150751_a(int p_150751_1_, Class p_150751_2_) {
        if (this.field_150769_h.containsKey((Object)p_150751_1_)) {
            String var3 = "Serverbound packet ID " + p_150751_1_ + " is already assigned to " + this.field_150769_h.get((Object)p_150751_1_) + "; cannot re-assign to " + p_150751_2_;
            LogManager.getLogger().fatal(var3);
            throw new IllegalArgumentException(var3);
        }
        if (this.field_150769_h.containsValue((Object)p_150751_2_)) {
            String var3 = "Serverbound packet " + p_150751_2_ + " is already assigned to ID " + this.field_150769_h.inverse().get((Object)p_150751_2_) + "; cannot re-assign to " + p_150751_1_;
            LogManager.getLogger().fatal(var3);
            throw new IllegalArgumentException(var3);
        }
    ...
    protected EnumConnectionState func_150756_b(int p_150756_1_, Class p_150756_2_) {
        if (this.field_150770_i.containsKey((Object)p_150756_1_)) {
            String var3 = "Clientbound packet ID " + p_150756_1_ + " is already assigned to " + this.field_150770_i.get((Object)p_150756_1_) + "; cannot re-assign to " + p_150756_2_;
            LogManager.getLogger().fatal(var3);
            throw new IllegalArgumentException(var3);
        }
        if (this.field_150770_i.containsValue((Object)p_150756_2_)) {
            String var3 = "Clientbound packet " + p_150756_2_ + " is already assigned to ID " + this.field_150770_i.inverse().get((Object)p_150756_2_) + "; cannot re-assign to " + p_150756_1_;
            LogManager.getLogger().fatal(var3);
            throw new IllegalArgumentException(var3);
        }
    ...
    public static EnumConnectionState func_150760_a(int p_150760_0_) {
        return (EnumConnectionState)((Object)field_150764_e.get(p_150760_0_));
    }

    public static EnumConnectionState func_150752_a(Packet p_150752_0_) {
        return (EnumConnectionState)((Object)field_150761_f.get(p_150752_0_.getClass()));
    }

    private EnumConnectionState(String ignore1, int ignore2, String var3, int var4, int n2, Object object) {
        this(string, n, (int)var3);
    }
