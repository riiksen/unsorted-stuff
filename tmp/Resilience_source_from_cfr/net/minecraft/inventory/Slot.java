...
public class Slot {
    ...
    public void onSlotChange(ItemStack par1ItemStack, ItemStack par2ItemStack) {
        int var3;
        if (par1ItemStack != null && par2ItemStack != null && par1ItemStack.getItem() == par2ItemStack.getItem() && (var3 = par2ItemStack.stackSize - par1ItemStack.stackSize) > 0) {
    ...
    public boolean isSlotInInventory(IInventory par1IInventory, int par2) {
        if (par1IInventory == this.inventory && par2 == this.slotIndex) {
            return true;
        }
        return false;
    }
