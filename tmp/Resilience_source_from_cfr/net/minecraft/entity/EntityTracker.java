...
public class EntityTracker {
    ...
    public void addEntityToTracker(Entity par1Entity) {
        if (par1Entity instanceof EntityPlayerMP) {
            ...
            for (EntityTrackerEntry var4 : this.trackedEntities) {
                if (var4.myEntity == var2) continue;
    ...
    public void addEntityToTracker(Entity par1Entity, int par2, final int par3, boolean par4) {
        ...
        try {
            ...
            var7.addCrashSection("Tracking range", String.valueOf(par2) + " blocks");
            ...
            ((EntityTrackerEntry)this.trackedEntityIDs.lookup((int)par1Entity.getEntityId())).myEntity.addEntityCrashInfo(var8);
            try {
    ...
    public void removeEntityFromAllTrackingPlayers(Entity par1Entity) {
        ...
        if ((var5 = (EntityTrackerEntry)this.trackedEntityIDs.removeObject(par1Entity.getEntityId())) != null) {
    ...
    public void updateTrackedEntities() {
        ...
        for (EntityTrackerEntry var3 : this.trackedEntities) {
            ...
            if (!var3.playerEntitiesUpdated || !(var3.myEntity instanceof EntityPlayerMP)) continue;
        ...
        while (var6 < var1.size()) {
            ...
            for (EntityTrackerEntry var5 : this.trackedEntities) {
                if (var5.myEntity == var7) continue;
    ...
    public void func_85172_a(EntityPlayerMP par1EntityPlayerMP, Chunk par2Chunk) {
        for (EntityTrackerEntry var4 : this.trackedEntities) {
            if (var4.myEntity == par1EntityPlayerMP || var4.myEntity.chunkCoordX != par2Chunk.xPosition || var4.myEntity.chunkCoordZ != par2Chunk.zPosition) continue;
